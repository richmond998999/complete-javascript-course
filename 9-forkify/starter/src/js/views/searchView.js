...
export const renderResults = (recipes, page = 1, resPerPage = 10) => {
    ...
    recipes.slice(start, end).forEach(renderRecipe);      // This will automatically pass each recipe to render recipe // slice will slice the array
    
    // Render pagination of buttons
